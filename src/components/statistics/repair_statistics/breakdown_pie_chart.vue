<template>
  <div>
    <!-- 饼状统计图 -->
    <div id="breakdown-pie-echarts" style="height:650px;"></div>
    <Button class="h-btn h-btn-s h-btn-blue export-btn" @click="exportExcel('breakdownPie')">导出Excel</Button>
    <div id="breakdownPie">
...
export default {
  ...
  methods: {
    ...
    pie() {
      ...
      let breakdownChart = echarts.init(document.getElementById('breakdown-pie-echarts'));
      let option = {
        tooltip: {
          trigger: 'item',
