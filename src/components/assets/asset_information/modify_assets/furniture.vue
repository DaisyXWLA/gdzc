        ...
        <Cell :width="24">
          ...
          >
            ...
            <FormItem label="数量" prop="number">
              <input type="text" v-model="AssetsAdd.number" readonly />
            </FormItem>
            ...
            <FormItem label="使用人">
              <Select v-model="AssetsAdd.useId" class="select-demo" :datas="useId" :filterable="true"></Select>
            </FormItem>
            <FormItem label="使用部门">
              <Select v-model="AssetsAdd.useDepartment" class="select-demo" :datas="useDepartment" :filterable="true"></Select>
            </FormItem>
            <FormItem label="管理部门">
              <Select
  ...
  methods: {
    ...
    submit() {
      ...
      if (validResult.result) {
        ...
        R.Assets.furnitureModify(AssetsModel.dispose(this.AssetsAdd)).then(resp => {
          if (resp.ok) {
            setTimeout(() => {
              this.loading = false;
