...
<template>
  <div>
    ...
    <header class="h-modal-header modal-title">编辑采购计划</header>
    <div>
      <div>
        <div style="padding:5px">
          ...
          >
            ...
            <FormItem label="申请人" prop="creator">
              <!-- <input type="text" v-model="PurchaseAdd.creatorName" /> -->
        ...
        <Row>
          <Cell :width="24">
            <Table ref="table" :datas="datas" :height="159" checkbox @select="selectData">
  ...
  methods: {
    ...
    save() {
      ...
      if (validResult.result) {
        ...
        this.PurchaseAdd.purchaseType = '采购计划';
