          ...
          <div>
            ...
            >
              ...
              <!-- <FormItem label="创建人" prop="creatorName">
                <input type="text" v-model="subContractorRepairList.creatorName" readonly />
              </FormItem>
              <FormItem label="创建时间" prop="createTime">
                <input type="text" v-model="subContractorRepairList.createTime" readonly />
              </FormItem>-->
              <FormItem label="备注" prop="remarks" single>
                <input type="text" v-model="subContractorRepairList.remarks" v-wordlimit="50" />
              </FormItem>
            </Form>
          </div>
          <Row>
  ...
  methods: {
    ...
    submit() {
      ...
      if (validResult.result) {
        ...
        this.$Loading();
        R.subContractorRepair.update(subContractorRepairModel.dispose(this.subContractorRepairList)).then(resp => {
          if (resp.ok) {
            setTimeout(() => {
              this.$parent.close();
              this.$Loading.close();
