...
<template>
  <div class="app-layout-setting-vue">
    <div class="h-modal-header modal-title">系统布局配置</div>
    <div class="h-panel">
      <div class="h-panel-body">
        <Form class="setting-form" :labelWidth="120" labelPosition="left" readonly>
          <FormItem label="Sider风格">
            <SwitchList
              v-model="layoutConfig.siderTheme"
              small
              :datas="{'white': '白色', 'dark': '暗色'}"
            ></SwitchList>
          </FormItem>
          ...
          <!-- <p
            class="dark-color font13"
            style="padding: 10px 15px;"
          >开启多Tab后，在 app-frame 中打开 keep-alive 才能开启页面缓存</p>-->
        </Form>
